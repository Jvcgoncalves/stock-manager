...
import { updateProductFromBackEnd } from "../../../scripts/updateProductFromBackEnd";

export default function EditProduct(){
  const {setAllUserProducts} = useContext(UserProducts)
  ...
  return(
    <div className="add-product-page">
      <form 
        onSubmit={async ev => {
          ev.preventDefault()
          await updateProductFromBackEnd(formData,setAllUserProducts)
          navigation(-1)
        }}
      >
